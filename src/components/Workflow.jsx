        ...
        <section className="py-10 bg-white sm:py-16 lg:py-24">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">A Streamlined Customized Process</h2>
                    <p className="max-w-2xl mx-auto mt-4 text-base leading-relaxed text-gray-600">We follow a time-tested process to craft high-impact 3D solutions that align with your project requirements.</p>
                </div>
