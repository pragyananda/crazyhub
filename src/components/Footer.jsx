  ...
  return (
    <footer className="bg-white" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32 ">
        <div className="sm:flex sm:justify-between sm:space-x-8">
          {/* Column 1 */}
          <div className="space-y-5 xl:w-1/4 mt-6 sm:mt-0 w-1/3">
            <NavLink to="/" className="logo text-black ml-10 text-[1.4rem]">Crazyhub</NavLink>
            <p className="text-sm leading-6 text-gray-600">
              <span className="text-center text-black underline">Contact Us</span> <br />
              Help Desk - +(91) 8979910906 <br />
              For Sales queries - info@crazyhub.com <br />
              +1 (634) 481-4328 <br />
              For Career queries - careers@crazyhub.com</p>
          ...
          {/* Column 2 */}
          <div className="xl:w-1/4 mt-6 sm:mt-0">
