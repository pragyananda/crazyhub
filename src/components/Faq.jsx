...
export const Faq = () => {
    ...
    return (
        <section className="py-3 bg-gray-50 sm:py-7 lg:py-10">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl flex">
                ...
                <div className="w-8/12 mx-auto space-y-4">
                    {faq.map((item, index) => (
                        <div key={index} className="transition-all duration-200 bg-white border border-gray-200 cursor-pointer hover:bg-gray-50 rounded-lg">
